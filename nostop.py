#!/usr/bin/env python
# trading_engine.py – Android‑ready trading bot
# (Originally nostop.py – Optimised REST Polling + Foreground Service)
...
try:
    ...
    # On Android this won't work, but buildozer will have included it
...
# ----------------------------------------------------------------------
# ENTRY POINT FOR ANDROID SERVICE (start_bot)
# ----------------------------------------------------------------------
def start_bot():
    ...
    # Keep the function alive (service will run until stopped)
    while running:
        time.sleep(1)
